"""
Example demonstrating TWTL-enhanced SELP for a drone navigation task.
"""
import sys
import os
import time
...
# Fix the Python path to find the modules
# Get the absolute path to the project root directory
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
sys.path.insert(0, project_root)

# Now import from the modules
from twtl.grammar import Atomic, Conjunction, WithinTime, AlwaysDuringTime, Sequence
from twtl.automaton import TimedAutomaton
from translator.nl_to_twtl import NLtoTWTL
from planner.constrained_decoding import TWTLConstrainedDecoding, ActionInfo
from monitoring.execution_monitor import TWTLExecutionMonitor
